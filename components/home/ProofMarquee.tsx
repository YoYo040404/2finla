...
export default function ProofMarquee() {
  ...
  return (
    <div
      ...
      aria-label="2T Jewelers: Downtown Pittsburgh jeweler, 25 years, text 2T before you buy, we quote first, no deposit to start, details confirmed per piece"
    >
